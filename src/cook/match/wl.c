...
int
match_wl_attempt(match_ty *mp, string_list_ty *formal, string_ty *actual,
...
int
match_wl_reconstruct_lhs(const match_ty *mp, string_list_ty *to,
    string_list_ty *from, const expr_position_ty *pp)
{
    size_t          j;
    string_ty       *s;
...
int
match_wl_reconstruct_rhs(const match_ty *mp, string_list_ty *to,
    string_list_ty *from, const expr_position_ty *pp)
{
    size_t          j;
    string_ty       *s;
...
int
match_wl_usage_mask(const match_ty *mp, string_list_ty *wlp,
    const expr_position_ty *pp)
{
    int             result;
    size_t          j;
