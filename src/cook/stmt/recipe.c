 ...
 *
 * MANIFEST: functions to manipulate recipe statement nodes
 */
...
stmt_ty *
stmt_recipe_new(target, need, need2, flags, multiple, precondition,
		single_thread, host_binding, action, use_action, pp)
	expr_list_ty	*target;
	expr_list_ty	*need;
	expr_list_ty	*need2;
	expr_list_ty	*flags;
