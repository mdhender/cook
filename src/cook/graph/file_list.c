...
void
graph_file_list_destructor(graph_file_list_ty *gflp)
{
    size_t          j;
...
void
graph_file_list_append(graph_file_list_ty *gflp, graph_file_ty *gfp,
    edge_type_ty et)
{
    size_t          j;
...
void
graph_file_list_append_list(graph_file_list_ty *to, graph_file_list_ty *from)
{
    size_t          j;
...
void
graph_file_list_nrc_append(graph_file_list_nrc_ty *gflp, graph_file_ty *gfp,
    edge_type_ty et)
{
    size_t          j;
    graph_file_and_type_ty *fat;
...
void
graph_file_list_nrc_append_list(graph_file_list_nrc_ty *to,
    graph_file_list_nrc_ty *from)
{
    size_t          j;
