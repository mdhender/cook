 ...
 *
 * MANIFEST: functions to scan C language files
 */
...
static int lang_c_scan _((input_ty *, string_list_ty *, string_list_ty *));

static int
lang_c_scan(fp, type1, type2)
	input_ty		*fp;
	string_list_ty	*type1;
	string_list_ty	*type2;
{
	...
	trace(("lang_c_scan(fp = %08lX, type1 = %08lX, \
type2 = %08lX)\n{\n"/*}*/, fp, type1, type2));
	pos = 0;
	max = 100;
	line = mem_alloc(max);
...
static void lang_c_prepare _((void));
