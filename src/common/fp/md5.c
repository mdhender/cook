 ...
 *	Copyright (C) 1994, 1996, 1997, 1999 Peter Miller;
 *	All rights reserved.
 *
...
static void md5_constructor _((fingerprint_ty *));
...
static void md5_destructor _((fingerprint_ty *));
...
static void Encode _((unsigned char *, unsigned long *, unsigned int));
...
static void Decode _((unsigned long *, unsigned char *, unsigned int));
...
static void MD5Transform _((unsigned long state[4], unsigned char block[64]));
...
static void md5_addn _((fingerprint_ty *, unsigned char *, int));

static void
md5_addn(p, input, inputLen)
	fingerprint_ty	*p;
...
static int md5_hash _((fingerprint_ty *, unsigned char *));
...
static void md5_sum _((fingerprint_ty *, char *));
