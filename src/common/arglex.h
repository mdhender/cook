 ...
 *      Copyright (C) 1991-1993, 1997, 2006, 2007 Peter Miller;
 *      All rights reserved.
 *
...
void arglex_init(int argc, char **argv, arglex_table_ty *table);
arglex_token_ty arglex(void);
int arglex_compare(const char *formal, const char *actual);
void arglex_init_from_env(char *argv0, arglex_table_ty *table);
